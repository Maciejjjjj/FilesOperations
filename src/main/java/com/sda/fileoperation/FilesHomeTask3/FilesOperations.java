...
import com.sda.fileoperation.FilesHomeTask3.factory.StudentRandomFactory;
...
public class FilesOperations {
    public static void main(String[] args) {
        ...
        for (Student student : students) studentListMap.put(students.indexOf(student) + 1, student);
